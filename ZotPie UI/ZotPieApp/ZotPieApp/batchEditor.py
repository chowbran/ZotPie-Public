...
class Ui_BatchEditorWindow(object):
    def setupUi(self, BatchEditorWindow):
        ...
        BatchEditorWindow.resize(829, 576)
        ...
        self.gridLayout.addWidget(self.lbl_Quaggan, 2, 4, 2, 1)
        ...
        self.list_Tags = QtGui.QListWidget(self.centralwidget)
        self.list_Tags.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        self.list_Tags.setObjectName(_fromUtf8("list_Tags"))
        self.horizontalLayout_4.addWidget(self.list_Tags)
        ...
        self.btn_Remove.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.list_ChangeTags = QtGui.QListWidget(self.centralwidget)
        self.list_ChangeTags.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        self.list_ChangeTags.setObjectName(_fromUtf8("list_ChangeTags"))
        self.horizontalLayout_4.addWidget(self.list_ChangeTags)
    ...
    def retranslateUi(self, BatchEditorWindow):
        ...
        self.btn_Add.setText(_translate("BatchEditorWindow", ">>", None))
        self.btn_Remove.setText(_translate("BatchEditorWindow", "<<", None))
