...
class Ui_BatchEditorWindow(object):
    def setupUi(self, BatchEditorWindow):
        ...
        BatchEditorWindow.resize(696, 236)
        ...
        self.gridLayout.addWidget(self.txt_NewValue, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.grp_Parameters, 2, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lbl_Quaggan, 1, 3, 2, 1)
