...
class Ui_CitationEditorWindow(object):
    def setupUi(self, CitationEditorWindow):
        ...
        self.combo_Fields.setGeometry(QtCore.QRect(60, 80, 91, 22))
        self.combo_Fields.setObjectName(_fromUtf8("combo_Fields"))
        self.combo_Fields.addItem(_fromUtf8(""))
        self.combo_Record = QtGui.QComboBox(self.grp_Parameters)
        self.combo_Record.setGeometry(QtCore.QRect(60, 40, 91, 22))
        self.combo_Record.setObjectName(_fromUtf8("combo_Record"))
        self.combo_Record.addItem(_fromUtf8(""))
        ...
        self.btn_Add.setGeometry(QtCore.QRect(180, 40, 75, 23))
        self.btn_Add.setObjectName(_fromUtf8("btn_Add"))
        self.btn_Remove = QtGui.QPushButton(self.grp_Parameters)
        self.btn_Remove.setGeometry(QtCore.QRect(280, 40, 75, 23))
    ...
    def retranslateUi(self, CitationEditorWindow):
        ...
        self.combo_Fields.setItemText(0, _translate("CitationEditorWindow", "Author", None))
        self.combo_Record.setItemText(0, _translate("CitationEditorWindow", "Book", None))
