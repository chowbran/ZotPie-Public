...
class Ui_CoupleDocumentsWindow(object):
    def setupUi(self, CoupleDocumentsWindow):
        ...
        CoupleDocumentsWindow.resize(881, 507)
        ...
        self.lbl_Description = QtGui.QLabel(self.tab_3)
        self.lbl_Description.setObjectName(_fromUtf8("lbl_Description"))
        self.verticalLayout_2.addWidget(self.lbl_Description)
        self.btn_Sync = QtGui.QPushButton(self.tab_3)
        self.btn_Sync.setMinimumSize(QtCore.QSize(0, 40))
        ...
        self.btn_Link = QtGui.QPushButton(self.tab)
        self.btn_Link.setObjectName(_fromUtf8("btn_Link"))
        self.gridLayout.addWidget(self.btn_Link, 3, 3, 1, 1)
        ...
        self.list_Original.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        ...
        self.list_Copy.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        ...
        self.gridLayout_3.addWidget(self.lbl_Original_Rem, 1, 0, 1, 1)
        self.list_Coupled = QtGui.QListWidget(self.tab_2)
        self.list_Coupled.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        self.list_Coupled.setObjectName(_fromUtf8("list_Coupled"))
        self.gridLayout_3.addWidget(self.list_Coupled, 4, 1, 1, 1)
        self.list_Original_Rem = QtGui.QListWidget(self.tab_2)
        self.list_Original_Rem.setSelectionMode(QtGui.QAbstractItemView.MultiSelection)
        self.list_Original_Rem.setObjectName(_fromUtf8("list_Original_Rem"))
        self.gridLayout_3.addWidget(self.list_Original_Rem, 4, 0, 1, 1)
        ...
        self.horizontalLayout_3.addWidget(self.btn_Uncouple)
        self.gridLayout_3.addLayout(self.horizontalLayout_3, 6, 1, 1, 1)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.combo_Group_Rem = QtGui.QComboBox(self.tab_2)
        self.combo_Group_Rem.setObjectName(_fromUtf8("combo_Group_Rem"))
        self.horizontalLayout_2.addWidget(self.combo_Group_Rem)
        self.combo_Copy_Rem = QtGui.QComboBox(self.tab_2)
        self.combo_Copy_Rem.setObjectName(_fromUtf8("combo_Copy_Rem"))
        self.horizontalLayout_2.addWidget(self.combo_Copy_Rem)
        self.gridLayout_3.addLayout(self.horizontalLayout_2, 2, 1, 1, 1)
        self.horizontalLayout_5 = QtGui.QHBoxLayout()
        self.horizontalLayout_5.setObjectName(_fromUtf8("horizontalLayout_5"))
        self.lbl_Group_Rem = QtGui.QLabel(self.tab_2)
        self.lbl_Group_Rem.setObjectName(_fromUtf8("lbl_Group_Rem"))
        self.horizontalLayout_5.addWidget(self.lbl_Group_Rem)
        self.lbl_Copy_Rem = QtGui.QLabel(self.tab_2)
        self.lbl_Copy_Rem.setObjectName(_fromUtf8("lbl_Copy_Rem"))
        self.horizontalLayout_5.addWidget(self.lbl_Copy_Rem)
    ...
    def retranslateUi(self, CoupleDocumentsWindow):
        ...
        self.lbl_Description.setText(_translate("CoupleDocumentsWindow", "<html><head/><body><p>Click the \'Sync\' button below to sync previously linked records.</p><p>To link new records, click on the &quot;Link Records&quot; tab above.</p><p>To unlink previously linked records, click on the &quot;Unlink Records&quot; tab above.</p></body></html>", None))
        self.btn_Sync.setText(_translate("CoupleDocumentsWindow", "Sync", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("CoupleDocumentsWindow", "Sync", None))
        ...
        self.btn_Link.setText(_translate("CoupleDocumentsWindow", "Link", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("CoupleDocumentsWindow", "Link Records", None))
        self.lbl_Original_Rem.setText(_translate("CoupleDocumentsWindow", "Collection of Original:", None))
        self.btn_Uncouple.setText(_translate("CoupleDocumentsWindow", "Unlink", None))
        self.lbl_Group_Rem.setText(_translate("CoupleDocumentsWindow", "Group of Copy:", None))
        self.lbl_Copy_Rem.setText(_translate("CoupleDocumentsWindow", "Collection of Copy:", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("CoupleDocumentsWindow", "Unlink Records", None))
