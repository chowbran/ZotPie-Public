...
class Ui_CoupleDocumentsWindow(object):
    def setupUi(self, CoupleDocumentsWindow):
        ...
        CoupleDocumentsWindow.resize(750, 490)
        ...
        self.list_Original = QtGui.QListWidget(self.tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Ignored, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.list_Original.sizePolicy().hasHeightForWidth())
        self.list_Original.setSizePolicy(sizePolicy)
        self.list_Original.setObjectName(_fromUtf8("list_Original"))
        self.gridLayout.addWidget(self.list_Original, 2, 0, 1, 2)
        self.list_Copy = QtGui.QListWidget(self.tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Ignored, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.list_Copy.sizePolicy().hasHeightForWidth())
        self.list_Copy.setSizePolicy(sizePolicy)
        ...
        self.list_Original_Rem = QtGui.QListWidget(self.tab_2)
        ...
        self.list_Coupled = QtGui.QListWidget(self.tab_2)
        self.list_Coupled.setObjectName(_fromUtf8("list_Coupled"))
        self.gridLayout_3.addWidget(self.list_Coupled, 3, 1, 1, 1)
